...
def six_month_return_from_high(start, end, **kwargs):
    start_date_pricedata = kwargs['data_source'].trade_calendar.tradeDayOffset(start, -10, '1m')
...
ReverseFuncListDaily = []
ReverseFuncListMonthly = [six_month_return_from_high]
